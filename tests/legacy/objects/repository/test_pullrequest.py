...
def test_pullrequest(pullrequest_fixtrue_response):
    ...
    assert (
        obj.review_comments_url == pullrequest_fixtrue_response["review_comments_url"]
    )
    ...
    assert (
        obj.user.followers_url == pullrequest_fixtrue_response["user"]["followers_url"]
    )
    assert (
        obj.user.following_url == pullrequest_fixtrue_response["user"]["following_url"]
    )
    ...
    assert (
        obj.user.subscriptions_url
        == pullrequest_fixtrue_response["user"]["subscriptions_url"]
    )
    assert (
        obj.user.organizations_url
        == pullrequest_fixtrue_response["user"]["organizations_url"]
    )
    ...
    assert (
        obj.user.received_events_url
        == pullrequest_fixtrue_response["user"]["received_events_url"]
    )
    ...
    assert (
        ...
        == pullrequest_fixtrue_response["labels"][0]["description"]
    )
    ...
    assert (
        obj.milestone.html_url == pullrequest_fixtrue_response["milestone"]["html_url"]
    )
    assert (
        obj.milestone.labels_url
        == pullrequest_fixtrue_response["milestone"]["labels_url"]
    )
    ...
    assert (
        obj.milestone.description
        == pullrequest_fixtrue_response["milestone"]["description"]
    )
    assert (
        obj.milestone.creator.login
        == pullrequest_fixtrue_response["milestone"]["creator"]["login"]
    )
    assert (
        obj.milestone.creator.id
        == pullrequest_fixtrue_response["milestone"]["creator"]["id"]
    )
    assert (
    ...
    assert (
        obj.milestone.creator.url
        == pullrequest_fixtrue_response["milestone"]["creator"]["url"]
    )
    assert (
    ...
    assert (
        obj.milestone.creator.type
        == pullrequest_fixtrue_response["milestone"]["creator"]["type"]
    )
    assert (
    ...
    assert (
        obj.milestone.open_issues
        == pullrequest_fixtrue_response["milestone"]["open_issues"]
    )
    assert (
        obj.milestone.closed_issues
        == pullrequest_fixtrue_response["milestone"]["closed_issues"]
    )
    assert (
        obj.milestone.created_at
        == pullrequest_fixtrue_response["milestone"]["created_at"]
    )
    assert (
        obj.milestone.updated_at
        == pullrequest_fixtrue_response["milestone"]["updated_at"]
    )
    assert (
        obj.milestone.closed_at
        == pullrequest_fixtrue_response["milestone"]["closed_at"]
    )
    ...
    assert (
        obj.assignee.avatar_url
        == pullrequest_fixtrue_response["assignee"]["avatar_url"]
    )
    assert (
        obj.assignee.gravatar_id
        == pullrequest_fixtrue_response["assignee"]["gravatar_id"]
    )
    ...
    assert (
        obj.assignee.followers_url
        == pullrequest_fixtrue_response["assignee"]["followers_url"]
    )
    assert (
        obj.assignee.following_url
        == pullrequest_fixtrue_response["assignee"]["following_url"]
    )
    assert (
        obj.assignee.gists_url == pullrequest_fixtrue_response["assignee"]["gists_url"]
    )
    assert (
        obj.assignee.starred_url
        == pullrequest_fixtrue_response["assignee"]["starred_url"]
    )
    assert (
    ...
    assert (
        obj.assignee.repos_url == pullrequest_fixtrue_response["assignee"]["repos_url"]
    )
    assert (
        obj.assignee.events_url
        == pullrequest_fixtrue_response["assignee"]["events_url"]
    )
    assert (
    ...
    assert (
        obj.assignee.site_admin
        == pullrequest_fixtrue_response["assignee"]["site_admin"]
    )
    assert (
        obj.assignees[0].login == pullrequest_fixtrue_response["assignees"][0]["login"]
    )
    assert obj.assignees[0].id == pullrequest_fixtrue_response["assignees"][0]["id"]
    assert (
        obj.assignees[0].node_id
        == pullrequest_fixtrue_response["assignees"][0]["node_id"]
    )
    assert (
        obj.assignees[0].avatar_url
        == pullrequest_fixtrue_response["assignees"][0]["avatar_url"]
    )
    assert (
        obj.assignees[0].gravatar_id
        == pullrequest_fixtrue_response["assignees"][0]["gravatar_id"]
    )
    assert obj.assignees[0].url == pullrequest_fixtrue_response["assignees"][0]["url"]
    assert (
        obj.assignees[0].html_url
        == pullrequest_fixtrue_response["assignees"][0]["html_url"]
    )
    assert (
    ...
    assert (
        obj.assignees[0].gists_url
        == pullrequest_fixtrue_response["assignees"][0]["gists_url"]
    )
    assert (
        obj.assignees[0].starred_url
        == pullrequest_fixtrue_response["assignees"][0]["starred_url"]
    )
    assert (
    ...
    assert (
        obj.assignees[0].repos_url
        == pullrequest_fixtrue_response["assignees"][0]["repos_url"]
    )
    assert (
        obj.assignees[0].events_url
        == pullrequest_fixtrue_response["assignees"][0]["events_url"]
    )
    assert (
    ...
    assert (
        obj.assignees[0].site_admin
        == pullrequest_fixtrue_response["assignees"][0]["site_admin"]
    )
    assert (
    ...
    assert (
        obj.requested_teams[0].url
        == pullrequest_fixtrue_response["requested_teams"][0]["url"]
    )
    assert (
    ...
    assert (
        obj.requested_teams[0].name
        == pullrequest_fixtrue_response["requested_teams"][0]["name"]
    )
    assert (
        obj.requested_teams[0].slug
        == pullrequest_fixtrue_response["requested_teams"][0]["slug"]
    )
    assert (
    ...
    assert (
        obj.head.user.node_id == pullrequest_fixtrue_response["head"]["user"]["node_id"]
    )
    assert (
        obj.head.user.avatar_url
        == pullrequest_fixtrue_response["head"]["user"]["avatar_url"]
    )
    assert (
        obj.head.user.gravatar_id
        == pullrequest_fixtrue_response["head"]["user"]["gravatar_id"]
    )
    assert obj.head.user.url == pullrequest_fixtrue_response["head"]["user"]["url"]
    assert (
        obj.head.user.html_url
        == pullrequest_fixtrue_response["head"]["user"]["html_url"]
    )
    assert (
        obj.head.user.followers_url
        == pullrequest_fixtrue_response["head"]["user"]["followers_url"]
    )
    assert (
        obj.head.user.following_url
        == pullrequest_fixtrue_response["head"]["user"]["following_url"]
    )
    assert (
        obj.head.user.gists_url
        == pullrequest_fixtrue_response["head"]["user"]["gists_url"]
    )
    assert (
        obj.head.user.starred_url
        == pullrequest_fixtrue_response["head"]["user"]["starred_url"]
    )
    assert (
    ...
    assert (
        obj.head.user.repos_url
        == pullrequest_fixtrue_response["head"]["user"]["repos_url"]
    )
    assert (
        obj.head.user.events_url
        == pullrequest_fixtrue_response["head"]["user"]["events_url"]
    )
    assert (
    ...
    assert (
        obj.head.user.site_admin
        == pullrequest_fixtrue_response["head"]["user"]["site_admin"]
    )
    assert obj.head.repo.id == pullrequest_fixtrue_response["head"]["repo"]["id"]
    assert (
        obj.head.repo.node_id == pullrequest_fixtrue_response["head"]["repo"]["node_id"]
    )
    assert obj.head.repo.name == pullrequest_fixtrue_response["head"]["repo"]["name"]
    assert (
        obj.head.repo.full_name
        == pullrequest_fixtrue_response["head"]["repo"]["full_name"]
    )
    assert (
        obj.head.repo.owner.login
        == pullrequest_fixtrue_response["head"]["repo"]["owner"]["login"]
    )
    assert (
        obj.head.repo.owner.id
        == pullrequest_fixtrue_response["head"]["repo"]["owner"]["id"]
    )
    assert (
    ...
    assert (
        obj.head.repo.owner.url
        == pullrequest_fixtrue_response["head"]["repo"]["owner"]["url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.owner.type
        == pullrequest_fixtrue_response["head"]["repo"]["owner"]["type"]
    )
    assert (
    ...
    assert (
        obj.head.repo.private == pullrequest_fixtrue_response["head"]["repo"]["private"]
    )
    assert (
        obj.head.repo.html_url
        == pullrequest_fixtrue_response["head"]["repo"]["html_url"]
    )
    assert (
        obj.head.repo.description
        == pullrequest_fixtrue_response["head"]["repo"]["description"]
    )
    ...
    assert (
        obj.head.repo.archive_url
        == pullrequest_fixtrue_response["head"]["repo"]["archive_url"]
    )
    assert (
        obj.head.repo.assignees_url
        == pullrequest_fixtrue_response["head"]["repo"]["assignees_url"]
    )
    assert (
        obj.head.repo.blobs_url
        == pullrequest_fixtrue_response["head"]["repo"]["blobs_url"]
    )
    assert (
        obj.head.repo.branches_url
        == pullrequest_fixtrue_response["head"]["repo"]["branches_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.comments_url
        == pullrequest_fixtrue_response["head"]["repo"]["comments_url"]
    )
    assert (
        obj.head.repo.commits_url
        == pullrequest_fixtrue_response["head"]["repo"]["commits_url"]
    )
    assert (
        obj.head.repo.compare_url
        == pullrequest_fixtrue_response["head"]["repo"]["compare_url"]
    )
    assert (
        obj.head.repo.contents_url
        == pullrequest_fixtrue_response["head"]["repo"]["contents_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.downloads_url
        == pullrequest_fixtrue_response["head"]["repo"]["downloads_url"]
    )
    assert (
        obj.head.repo.events_url
        == pullrequest_fixtrue_response["head"]["repo"]["events_url"]
    )
    assert (
        obj.head.repo.forks_url
        == pullrequest_fixtrue_response["head"]["repo"]["forks_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.git_refs_url
        == pullrequest_fixtrue_response["head"]["repo"]["git_refs_url"]
    )
    assert (
        obj.head.repo.git_tags_url
        == pullrequest_fixtrue_response["head"]["repo"]["git_tags_url"]
    )
    assert (
        obj.head.repo.git_url == pullrequest_fixtrue_response["head"]["repo"]["git_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.issues_url
        == pullrequest_fixtrue_response["head"]["repo"]["issues_url"]
    )
    assert (
        obj.head.repo.keys_url
        == pullrequest_fixtrue_response["head"]["repo"]["keys_url"]
    )
    assert (
        obj.head.repo.labels_url
        == pullrequest_fixtrue_response["head"]["repo"]["labels_url"]
    )
    assert (
        obj.head.repo.languages_url
        == pullrequest_fixtrue_response["head"]["repo"]["languages_url"]
    )
    assert (
        obj.head.repo.merges_url
        == pullrequest_fixtrue_response["head"]["repo"]["merges_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.pulls_url
        == pullrequest_fixtrue_response["head"]["repo"]["pulls_url"]
    )
    assert (
        obj.head.repo.releases_url
        == pullrequest_fixtrue_response["head"]["repo"]["releases_url"]
    )
    assert (
        obj.head.repo.ssh_url == pullrequest_fixtrue_response["head"]["repo"]["ssh_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.statuses_url
        == pullrequest_fixtrue_response["head"]["repo"]["statuses_url"]
    )
    assert (
    ...
    assert (
        obj.head.repo.tags_url
        == pullrequest_fixtrue_response["head"]["repo"]["tags_url"]
    )
    assert (
        obj.head.repo.teams_url
        == pullrequest_fixtrue_response["head"]["repo"]["teams_url"]
    )
    assert (
        obj.head.repo.trees_url
        == pullrequest_fixtrue_response["head"]["repo"]["trees_url"]
    )
    assert (
        obj.head.repo.clone_url
        == pullrequest_fixtrue_response["head"]["repo"]["clone_url"]
    )
    assert (
        obj.head.repo.mirror_url
        == pullrequest_fixtrue_response["head"]["repo"]["mirror_url"]
    )
    assert (
        obj.head.repo.hooks_url
        == pullrequest_fixtrue_response["head"]["repo"]["hooks_url"]
    )
    assert (
        obj.head.repo.svn_url == pullrequest_fixtrue_response["head"]["repo"]["svn_url"]
    )
    assert (
        obj.head.repo.homepage
        == pullrequest_fixtrue_response["head"]["repo"]["homepage"]
    )
    assert (
        obj.head.repo.language
        == pullrequest_fixtrue_response["head"]["repo"]["language"]
    )
    assert (
        obj.head.repo.forks_count
        == pullrequest_fixtrue_response["head"]["repo"]["forks_count"]
    )
    assert (
    ...
    assert (
        obj.head.repo.is_template
        == pullrequest_fixtrue_response["head"]["repo"]["is_template"]
    )
    assert (
        obj.head.repo.topics[0]
        == pullrequest_fixtrue_response["head"]["repo"]["topics"][0]
    )
    assert (
        obj.head.repo.has_issues
        == pullrequest_fixtrue_response["head"]["repo"]["has_issues"]
    )
    assert (
        obj.head.repo.has_projects
        == pullrequest_fixtrue_response["head"]["repo"]["has_projects"]
    )
    assert (
        obj.head.repo.has_wiki
        == pullrequest_fixtrue_response["head"]["repo"]["has_wiki"]
    )
    assert (
        obj.head.repo.has_pages
        == pullrequest_fixtrue_response["head"]["repo"]["has_pages"]
    )
    assert (
        obj.head.repo.has_downloads
        == pullrequest_fixtrue_response["head"]["repo"]["has_downloads"]
    )
    assert (
        obj.head.repo.archived
        == pullrequest_fixtrue_response["head"]["repo"]["archived"]
    )
    assert (
        obj.head.repo.disabled
        == pullrequest_fixtrue_response["head"]["repo"]["disabled"]
    )
    assert (
        obj.head.repo.visibility
        == pullrequest_fixtrue_response["head"]["repo"]["visibility"]
    )
    assert (
        obj.head.repo.pushed_at
        == pullrequest_fixtrue_response["head"]["repo"]["pushed_at"]
    )
    assert (
        obj.head.repo.created_at
        == pullrequest_fixtrue_response["head"]["repo"]["created_at"]
    )
    assert (
        obj.head.repo.updated_at
        == pullrequest_fixtrue_response["head"]["repo"]["updated_at"]
    )
    assert (
    ...
    assert (
        obj.head.repo.network_count
        == pullrequest_fixtrue_response["head"]["repo"]["network_count"]
    )
    ...
    assert (
        obj.base.user.node_id == pullrequest_fixtrue_response["base"]["user"]["node_id"]
    )
    assert (
        obj.base.user.avatar_url
        == pullrequest_fixtrue_response["base"]["user"]["avatar_url"]
    )
    assert (
        obj.base.user.gravatar_id
        == pullrequest_fixtrue_response["base"]["user"]["gravatar_id"]
    )
    assert obj.base.user.url == pullrequest_fixtrue_response["base"]["user"]["url"]
    assert (
        obj.base.user.html_url
        == pullrequest_fixtrue_response["base"]["user"]["html_url"]
    )
    assert (
        obj.base.user.followers_url
        == pullrequest_fixtrue_response["base"]["user"]["followers_url"]
    )
    assert (
        obj.base.user.following_url
        == pullrequest_fixtrue_response["base"]["user"]["following_url"]
    )
    assert (
        obj.base.user.gists_url
        == pullrequest_fixtrue_response["base"]["user"]["gists_url"]
    )
    assert (
        obj.base.user.starred_url
        == pullrequest_fixtrue_response["base"]["user"]["starred_url"]
    )
    assert (
    ...
    assert (
        obj.base.user.repos_url
        == pullrequest_fixtrue_response["base"]["user"]["repos_url"]
    )
    assert (
        obj.base.user.events_url
        == pullrequest_fixtrue_response["base"]["user"]["events_url"]
    )
    assert (
    ...
    assert (
        obj.base.user.site_admin
        == pullrequest_fixtrue_response["base"]["user"]["site_admin"]
    )
    assert obj.base.repo.id == pullrequest_fixtrue_response["base"]["repo"]["id"]
    assert (
        obj.base.repo.node_id == pullrequest_fixtrue_response["base"]["repo"]["node_id"]
    )
    assert obj.base.repo.name == pullrequest_fixtrue_response["base"]["repo"]["name"]
    assert (
        obj.base.repo.full_name
        == pullrequest_fixtrue_response["base"]["repo"]["full_name"]
    )
    assert (
        obj.base.repo.owner.login
        == pullrequest_fixtrue_response["base"]["repo"]["owner"]["login"]
    )
    assert (
        obj.base.repo.owner.id
        == pullrequest_fixtrue_response["base"]["repo"]["owner"]["id"]
    )
    assert (
    ...
    assert (
        obj.base.repo.owner.url
        == pullrequest_fixtrue_response["base"]["repo"]["owner"]["url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.owner.type
        == pullrequest_fixtrue_response["base"]["repo"]["owner"]["type"]
    )
    assert (
    ...
    assert (
        obj.base.repo.private == pullrequest_fixtrue_response["base"]["repo"]["private"]
    )
    assert (
        obj.base.repo.html_url
        == pullrequest_fixtrue_response["base"]["repo"]["html_url"]
    )
    assert (
        obj.base.repo.description
        == pullrequest_fixtrue_response["base"]["repo"]["description"]
    )
    ...
    assert (
        obj.base.repo.archive_url
        == pullrequest_fixtrue_response["base"]["repo"]["archive_url"]
    )
    assert (
        obj.base.repo.assignees_url
        == pullrequest_fixtrue_response["base"]["repo"]["assignees_url"]
    )
    assert (
        obj.base.repo.blobs_url
        == pullrequest_fixtrue_response["base"]["repo"]["blobs_url"]
    )
    assert (
        obj.base.repo.branches_url
        == pullrequest_fixtrue_response["base"]["repo"]["branches_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.comments_url
        == pullrequest_fixtrue_response["base"]["repo"]["comments_url"]
    )
    assert (
        obj.base.repo.commits_url
        == pullrequest_fixtrue_response["base"]["repo"]["commits_url"]
    )
    assert (
        obj.base.repo.compare_url
        == pullrequest_fixtrue_response["base"]["repo"]["compare_url"]
    )
    assert (
        obj.base.repo.contents_url
        == pullrequest_fixtrue_response["base"]["repo"]["contents_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.downloads_url
        == pullrequest_fixtrue_response["base"]["repo"]["downloads_url"]
    )
    assert (
        obj.base.repo.events_url
        == pullrequest_fixtrue_response["base"]["repo"]["events_url"]
    )
    assert (
        obj.base.repo.forks_url
        == pullrequest_fixtrue_response["base"]["repo"]["forks_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.git_refs_url
        == pullrequest_fixtrue_response["base"]["repo"]["git_refs_url"]
    )
    assert (
        obj.base.repo.git_tags_url
        == pullrequest_fixtrue_response["base"]["repo"]["git_tags_url"]
    )
    assert (
        obj.base.repo.git_url == pullrequest_fixtrue_response["base"]["repo"]["git_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.issues_url
        == pullrequest_fixtrue_response["base"]["repo"]["issues_url"]
    )
    assert (
        obj.base.repo.keys_url
        == pullrequest_fixtrue_response["base"]["repo"]["keys_url"]
    )
    assert (
        obj.base.repo.labels_url
        == pullrequest_fixtrue_response["base"]["repo"]["labels_url"]
    )
    assert (
        obj.base.repo.languages_url
        == pullrequest_fixtrue_response["base"]["repo"]["languages_url"]
    )
    assert (
        obj.base.repo.merges_url
        == pullrequest_fixtrue_response["base"]["repo"]["merges_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.pulls_url
        == pullrequest_fixtrue_response["base"]["repo"]["pulls_url"]
    )
    assert (
        obj.base.repo.releases_url
        == pullrequest_fixtrue_response["base"]["repo"]["releases_url"]
    )
    assert (
        obj.base.repo.ssh_url == pullrequest_fixtrue_response["base"]["repo"]["ssh_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.statuses_url
        == pullrequest_fixtrue_response["base"]["repo"]["statuses_url"]
    )
    assert (
    ...
    assert (
        obj.base.repo.tags_url
        == pullrequest_fixtrue_response["base"]["repo"]["tags_url"]
    )
    assert (
        obj.base.repo.teams_url
        == pullrequest_fixtrue_response["base"]["repo"]["teams_url"]
    )
    assert (
        obj.base.repo.trees_url
        == pullrequest_fixtrue_response["base"]["repo"]["trees_url"]
    )
    assert (
        obj.base.repo.clone_url
        == pullrequest_fixtrue_response["base"]["repo"]["clone_url"]
    )
    assert (
        obj.base.repo.mirror_url
        == pullrequest_fixtrue_response["base"]["repo"]["mirror_url"]
    )
    assert (
        obj.base.repo.hooks_url
        == pullrequest_fixtrue_response["base"]["repo"]["hooks_url"]
    )
    assert (
        obj.base.repo.svn_url == pullrequest_fixtrue_response["base"]["repo"]["svn_url"]
    )
    assert (
        obj.base.repo.homepage
        == pullrequest_fixtrue_response["base"]["repo"]["homepage"]
    )
    assert (
        obj.base.repo.language
        == pullrequest_fixtrue_response["base"]["repo"]["language"]
    )
    assert (
        obj.base.repo.forks_count
        == pullrequest_fixtrue_response["base"]["repo"]["forks_count"]
    )
    assert (
    ...
    assert (
        obj.base.repo.is_template
        == pullrequest_fixtrue_response["base"]["repo"]["is_template"]
    )
    assert (
        obj.base.repo.topics[0]
        == pullrequest_fixtrue_response["base"]["repo"]["topics"][0]
    )
    assert (
        obj.base.repo.has_issues
        == pullrequest_fixtrue_response["base"]["repo"]["has_issues"]
    )
    assert (
        obj.base.repo.has_projects
        == pullrequest_fixtrue_response["base"]["repo"]["has_projects"]
    )
    assert (
        obj.base.repo.has_wiki
        == pullrequest_fixtrue_response["base"]["repo"]["has_wiki"]
    )
    assert (
        obj.base.repo.has_pages
        == pullrequest_fixtrue_response["base"]["repo"]["has_pages"]
    )
    assert (
        obj.base.repo.has_downloads
        == pullrequest_fixtrue_response["base"]["repo"]["has_downloads"]
    )
    assert (
        obj.base.repo.archived
        == pullrequest_fixtrue_response["base"]["repo"]["archived"]
    )
    assert (
        obj.base.repo.disabled
        == pullrequest_fixtrue_response["base"]["repo"]["disabled"]
    )
    assert (
        obj.base.repo.visibility
        == pullrequest_fixtrue_response["base"]["repo"]["visibility"]
    )
    assert (
        obj.base.repo.pushed_at
        == pullrequest_fixtrue_response["base"]["repo"]["pushed_at"]
    )
    assert (
        obj.base.repo.created_at
        == pullrequest_fixtrue_response["base"]["repo"]["created_at"]
    )
    assert (
        obj.base.repo.updated_at
        == pullrequest_fixtrue_response["base"]["repo"]["updated_at"]
    )
    assert (
    ...
    assert (
        obj.base.repo.network_count
        == pullrequest_fixtrue_response["base"]["repo"]["network_count"]
    )
    ...
    assert (
        obj.merged_by.avatar_url
        == pullrequest_fixtrue_response["merged_by"]["avatar_url"]
    )
    assert (
        obj.merged_by.gravatar_id
        == pullrequest_fixtrue_response["merged_by"]["gravatar_id"]
    )
    assert obj.merged_by.url == pullrequest_fixtrue_response["merged_by"]["url"]
    assert (
        obj.merged_by.html_url == pullrequest_fixtrue_response["merged_by"]["html_url"]
    )
    assert (
        obj.merged_by.followers_url
        == pullrequest_fixtrue_response["merged_by"]["followers_url"]
    )
    assert (
        obj.merged_by.following_url
        == pullrequest_fixtrue_response["merged_by"]["following_url"]
    )
    assert (
        obj.merged_by.gists_url
        == pullrequest_fixtrue_response["merged_by"]["gists_url"]
    )
    assert (
        obj.merged_by.starred_url
        == pullrequest_fixtrue_response["merged_by"]["starred_url"]
    )
    assert (
    ...
    assert (
        obj.merged_by.repos_url
        == pullrequest_fixtrue_response["merged_by"]["repos_url"]
    )
    assert (
        obj.merged_by.events_url
        == pullrequest_fixtrue_response["merged_by"]["events_url"]
    )
    assert (
    ...
    assert (
        obj.merged_by.site_admin
        == pullrequest_fixtrue_response["merged_by"]["site_admin"]
    )
    ...
    assert (
        obj.maintainer_can_modify
        == pullrequest_fixtrue_response["maintainer_can_modify"]
    )
